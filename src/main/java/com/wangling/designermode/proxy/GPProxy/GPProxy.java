...
public class GPProxy {
    ...
    private static String generateSrc(Class<?>[] interfaces){
        ...
        sb.append("package com.wangling.designermode.proxy.GPProxy;" + ln);
        sb.append("import com.wangling.designermode.proxy.sdkProxy.Person;" + ln);
